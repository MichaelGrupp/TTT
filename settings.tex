...
% page geometry
\def\borderleft{20mm} % constant needed for title page
\def\borderright{20mm} % constant needed for title page
\usepackage[left=\borderleft , right=\borderright , top=30mm, bottom=25mm]{geometry}
